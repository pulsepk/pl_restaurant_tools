...
-- Copied from object_gizmo/client/dataview.lua — needed locally so propattach.lua
-- can drive the native DrawGizmo widget (0xEB2EDCA2) itself without depending
-- on the object_gizmo resource being installed/running.
